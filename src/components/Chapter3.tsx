  ...
  return (
    <section className="chapter-section min-h-screen py-24 px-6 relative overflow-hidden bg-white">
      <div
        ...
        style={{
          background: 'radial-gradient(circle at 80% 20%, #fed7aa 0%, transparent 50%)',
        }}
      />

      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-20">
          <div className="inline-block mb-6 px-6 py-2 bg-orange-100 rounded-full border border-orange-300">
            <span className="text-sm font-bold text-orange-600">Chapter 3</span>
          </div>
          <h2 className="text-7xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">
            How Oil Got Into Everything
          </h2>
          <p className="text-2xl text-slate-600 font-semibold">From refinery to everyday life</p>
        </div>
